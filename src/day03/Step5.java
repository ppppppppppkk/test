...
public class Step5 {    // c s
    public static void main(String[] args) { // m s
        ...
        //문제2 : 점수를 입력받아 점수가 90점 이상이면 'A등급', 80점 이상이면 'B등급', 70점 이상이면 'C등급', 그외 '재시험' 으로 출력 하시오.
            ...
            else {System.out.println("나머지 재시험");};

        //문제3 : 임의의 정수 3개 를 입력받아서 오름차순 으로 3개의 변수를 출력하시오.
        /*
        System.out.println("정수 1 입력:"); int a = scanner.nextInt();
        System.out.println("정수 2 입력:"); int b = scanner.nextInt();
        System.out.println("정수 3 입력:"); int c = scanner.nextInt();

        int temp = 0;
        if(a>b){temp=a; a=b; b=temp;} // 조건 충족시 a와 값을 교체
        if(a>c){temp=a; a=c; c=temp;} // 조건 충족시 a와
        ...
        */
        ...
        if(year%4==0 && year%100==0 && year%400==0){
            System.out.println("입력한" + year + "연도는윤년입니다.");
        }
        else if(year%4==0 && year%100==0){
            System.out.println("입력한"+year+ "연도는 평년입니다.");
        }
        else if(year%4==0){
            System.out.println("입력한"+year+ "연도는 윤년입니다.");
        }
        */
   ...
   [ 처리출력 조건 ] 1분당 1000원으로 계산하여 사용요금' 0000원' 을 출력하시오,
        */
        ...
        int 입차시 = 14;
        int 입차분 = 30;
        System.out.println("출차시간을입력하세요"); int 출차시 = scanner.nextInt();
        System.out.println("출차 분을 입력하세요"); int 출차분 = scanner.nextInt();
        int 금액 = 0;
        if(출차시 > 입차시){
            int 총사용한시간 = ((출차시-입차시)*60) +출차분 - 입차분;
            금액 = 총사용한시간 * 1000;
        ...
        */
        ...
        if( a == 공1 || b == 공2 || b == 공3) { result++;}
        if( a == 공1 || c == 공2 || c == 공3) { result++;}
